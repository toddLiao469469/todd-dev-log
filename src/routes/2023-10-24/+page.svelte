...
<Post>
  <article slot="post_content">
    ...
    <p>
      ...
      heptabase 之後我覺得我在複習一個知識時變得更加輕鬆，總而言之我非常推薦這個軟體，除了軟體本身好用以外 heptabase
      非常認真在經營使用者社群。他們的 cs
      (其實我不確定是不是這個職稱，但總之就是負責客戶關係的成員)，前陣子開始預約諮詢的活動，可以跟他討論有關 hetpabase
      各種事情。我後來也有跟他約時間討論看看，我覺得十分有幫助畢竟這個軟體其實有那麼一點複雜，但我覺得複雜的點是因為跟過去習慣的概念不太一樣，但我覺得只要試著採用他們建議的使用方法體驗會好非常多。
    </p>
    <p>
      在
      <strong>回到Axton</strong>
      這個 yt 頻道聽過這麼一段話原文有點忘了，大意大概是：
    </p>
