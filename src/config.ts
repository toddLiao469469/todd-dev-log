...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/toddLiao469469',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'Todd Liao',
  bio: `目前在 Ionex 擔任軟體工程師最近在研究 Haskell 和 Svelte`,
  links: [
    {
      name: 'Twitter',
      ...
      url: 'https://x.com/toddLiao469469',
    },
    {
      name: 'GitHub',
      icon: 'fa6-brands:github',
      url: 'https://github.com/toddLiao469469',
    },
  ],
}
